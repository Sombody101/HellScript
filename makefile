...
build-runtime-win:
	dotnet publish $(HS_RUNTIME) -r win-x64 -c Release -o $(BUILD_DIR)

build-runtime-linux:
	dotnet publish $(HS_RUNTIME) -r linux-x64 -c Release -o $(BUILD_DIR)
...
build-compiler-win:
	dotnet publish $(HS_COMPILER) -r win-x64 -c Release -o $(BUILD_DIR)

build-compiler-linux:
	dotnet publish $(HS_COMPILER) -r linux-x64 -c Release -o $(BUILD_DIR)